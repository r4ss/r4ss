...
- retroSummary:
  ...
  that summarizes the results of a set of retrospective analysis
  models.ss

- endyrvec:

  Vector of years representing the final year of values to show for each
  model.
...
- legend:
  ...
  Add a legend showing which color goes with which line (as alternative
  to `labelyears`).
...
Eastern Bering Sea. (Figure 1.31, which is on an absolute, rather than
log scale.)
