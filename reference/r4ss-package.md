...
Synthesis versions 3.24 through 3.30 (specifically version 3.30.25, from
June 2026). Support for 3.24 models is only through the core functions
for reading output and plotting.
