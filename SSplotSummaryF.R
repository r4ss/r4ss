SSplotSummaryF <- function(replist,yrs="all",Ftgt=NA) {
    ...
    plot(as.numeric(substring(Ftot$LABEL,3,6)),Ftot$Value,pch=16,type="p",xlab="Year",ylab="Summary harvest rate",ylim=c(0,Fmax),cex.lab=1.0,cex.axis=1.0,cex=0.7)
