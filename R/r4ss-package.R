...
#' @importFrom stats acf aggregate density dnorm loess median na.omit nlminb optim pnorm qbeta qchisq qlnorm qnorm qt quantile rnorm sd var window
#' @importFrom utils browseURL flush.console head packageDescription read.csv read.table tail write.csv write.table
#'
#' @examples
#' \dontrun{
