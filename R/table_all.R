...
table_all <- function(
  ...
  tables[["table_config"]] <- table_config(
    replist = replist,
    dir = dir,
    verbose = verbose
  )
  tables[["table_exec_summary"]] <- table_exec_summary(
    replist = replist,
    dir = dir,
    verbose = verbose
  )
  tables[["table_pars"]] <- table_pars(
    replist = replist,
    dir = dir,
    verbose = verbose
  )
  tables[["table_parcounts"]] <- table_parcounts(
    replist = replist,
    dir = dir,
    verbose = verbose
  )
  tables[["table_ts"]] <- table_ts(
    replist = replist,
    dir = dir,
    verbose = verbose
  )
