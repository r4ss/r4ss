  ...
  function(
    ...
    if (is.null(tagdbase2) || nrow(tagdbase2) == 0) {
      ...
      if (!is.null(taggroups)) {
        ...
        cli::cli_inform("Filtered tag groups for plotting based on input vector taggroupsPlots will show{length(unique(tagdbase2[['Repl.']]))}out of{length(unique(replist[['tagdbase2']][['Repl.']]))}total included in the model.")
      }
