           ...
           mcmcVec="default")
{
  ...
  addpoly <- function(yrvec, lower, upper, uncertainty){
  ...
  plotSpawnBio <- function(show_uncertainty=TRUE){
    ...
    if(show_uncertainty){
      arrows(x0=xEqu, y0=as.numeric(SpawnBioLower[1,models[uncertainty]]),
             x1=xEqu, y1=as.numeric(SpawnBioUpper[1,models[uncertainty]]),
