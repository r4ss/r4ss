...
[![R-CMD-check\(master\)](https://github.com/r4ss/r4ss/workflows/R-CMD-check/badge.svg?branch=master)](https://github.com/r4ss/r4ss/actions?query=workflow%3AR-CMD-check)
[![R-CMD-check\(development\)](https://github.com/r4ss/r4ss/workflows/R-CMD-check/badge.svg)](https://github.com/r4ss/r4ss/actions?query=workflow%3AR-CMD-check)
