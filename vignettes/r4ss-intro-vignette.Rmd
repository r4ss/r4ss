...
```{r, read-output, eval=FALSE, echo=TRUE, message=FALSE}
...
```{r, make-subset-of-plots, eval=FALSE}
...
```{r, setup-retros, echo=TRUE, message=FALSE, warning=FALSE, eval=TRUE, results=FALSE}
...
```{r, get-retro-output, eval=TRUE, warning=FALSE, message=FALSE, out.width="75%"}
# load the 6 models
